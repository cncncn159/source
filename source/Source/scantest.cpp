	...
	ui(new Ui::ScanTest)
{
	...
	//lineedit1->setFont(QFont("Microsoft YaHei", 8, QFont::Normal));
	//lineedit1->setText(" 11111111 11111111 ");

	//lineedit2->setMaxLength(20);
	//lineedit2->setFont(QFont("Microsoft YaHei", 8, QFont::Normal));
	//lineedit2->setText(" 00000000 00000000 ");

	//lineedit3->setMaxLength(20);
	//lineedit3->setFont(QFont("Microsoft YaHei", 8, QFont::Normal));
	//lineedit3->setText(" ******** ******** ");

	//lineedit4->setMaxLength(20);
	//lineedit4->setFont(QFont("Microsoft YaHei", 8, QFont::Normal));
	//lineedit4->setText(" 00000000 00000000 ");

	//lineedit5->setMaxLength(20);
	//lineedit5->setFont(QFont("Microsoft YaHei", 8, QFont::Normal));
	//lineedit5->setText(" 00000000 00000000 ");

	//lineedit6->setMaxLength(20);
	//lineedit6->setFont(QFont("Microsoft YaHei", 8, QFont::Normal));
	//lineedit6->setText(" 00000000 00000000 ");

	//lineedit7->setMaxLength(20);
	//lineedit7->setFont(QFont("Microsoft YaHei", 8, QFont::Normal));
	//lineedit7->setText(" 00000000 00000000 ");

	//lineedit8->setMaxLength(20);
	//lineedit8->setFont(QFont("Microsoft YaHei", 8, QFont::Normal));
